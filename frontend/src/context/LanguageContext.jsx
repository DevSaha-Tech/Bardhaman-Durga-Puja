...
const translations = {
  bn: {
    ...
    hero_intro_text: "বর্ধমান ও কাটোয়ার সেরা দুর্গাপূজা মণ্ডপগুলো সবচেয়ে কম সময়ে ঘুরে দেখুন। আমাদের রুট প্ল্যানার স্বয়ংক্রিয়ভাবে সবচেয়ে কম দূরত্বে রুট তৈরি করে, এবং বাংলায় ভয়েস গাইড দিয়ে হাঁটার পথ দেখায়। ফ্রি, লগইন ছাড়াই।",

    // Section 2: Features
    feat_sec_title: "শুধু রুট প্ল্যানার নয়",
    feat_sec_sub: "পূজো পরিক্রমার সব টুল",
    feat1_card_t: "সেরা মণ্ডপ এক ট্যাপে",
    feat1_card_d: "Top 5, Top 10 বা Top 15 — সিস্টেম নিজেই সেরা রুট বানায়।",
    feat2_card_t: "সময় অনুযায়ী রুট",
    feat2_card_d: "২ ঘণ্টা থেকে সারা দিন — যতটা সময় আছে, ততটাই মণ্ডপ।",
    feat3_card_t: "যেকোনো মণ্ডপ খুঁজুন",
    feat3_card_d: "সার্চ করে সরাসরি Google Maps-এ navigate করুন।",
    feat4_card_t: "নিজের রুট বানান",
    feat4_card_d: "ম্যাপ থেকে পছন্দের মণ্ডপ বাছুন, সিস্টেম রুট সাজিয়ে দেবে।",
    feat5_card_t: "বন্ধুদের সাথে শেয়ার",
    feat5_card_d: "রুট বানিয়ে লিংক শেয়ার করুন, বন্ধুরাও একই রুট পাবে।",
    feat6_card_t: "বাংলায় ভয়েস গাইড",
    feat6_card_d: "মোড়ে মোড়ে বাংলায় নির্দেশনা, ফোনে তাকাতে হবে না।",

    // Section 3: How it works
    hiw_sec_title: "কীভাবে ব্যবহার করবেন?",
    hiw_sec_sub: "মাত্র ৪টি সহজ ধাপে শুরু করুন",
    hiw1_n: "০১",
    hiw1_t: "লোকেশন চালু করুন",
    hiw1_d: "ব্রাউজার আপনার অবস্থান শনাক্ত করবে।",
    hiw2_n: "০২",
    hiw2_t: "সময় বেছে নিন",
    hiw2_d: "২/৪/৬ ঘণ্টা বেছে নিন, বা Top 5 / Top 10 ট্যাপ করুন।",
    hiw3_n: "০৩",
    hiw3_t: "পরিক্রমা শুরু করুন",
    hiw3_d: "এক ট্যাপে রুট তৈরি হবে, তারপর হাঁটতে শুরু করুন।",
    hiw4_n: "০৪",
    hiw4_t: "রুট অনুসরণ করুন",
    hiw4_d: "নীল রুট ও বাংলা ভয়েস গাইড অনুসরণ করুন।",
    ...
    biz_sec_sub: "কাছের দোকান ও খাবারের জায়গা",
    biz_sponsored: "(স্পনসর্ড)",
    biz_empty: "আপনার ব্যবসা এখানে দেখাতে চান? যোগাযোগ করুন: +91 62951 11477, +91 99079 62182",
  ...
  en: {
    ...
    hero_intro_text: "Visit the best Durga Puja pandals in Bardhaman and Katwa in the least time. Our route planner builds the shortest path automatically and guides you with Bengali voice navigation. Free, no login.",

    // Section 2: Features
    feat_sec_title: "More Than a Route Planner",
    feat_sec_sub: "Tools for every Puja parikrama",
    feat1_card_t: "Top Pandals, One Tap",
    feat1_card_d: "Top 5, Top 10, or Top 15 — auto-routed for you.",
    feat2_card_t: "Time-Based Routing",
    feat2_card_d: "From 2 hours to all day, we fit as many pandals as possible.",
    feat3_card_t: "Find Any Pandal",
    feat3_card_d: "Search and navigate directly in Google Maps.",
    feat4_card_t: "Build Your Own Route",
    feat4_card_d: "Pick pandals from the map, we sort the best route.",
    feat5_card_t: "Share with Friends",
    feat5_card_d: "Build a route, share the link, friends follow the same.",
    feat6_card_t: "Bengali Voice Guide",
    feat6_card_d: "Turn-by-turn Bengali instructions. Hands-free.",

    // Section 3: How it works
    hiw_sec_title: "How to use?",
    hiw_sec_sub: "Start in just 4 easy steps",
    hiw1_n: "01",
    hiw1_t: "Turn on Location",
    hiw1_d: "Browser will detect your live location.",
    hiw2_n: "02",
    hiw2_t: "Select Time",
    hiw2_d: "Pick 2/4/6 hours, or tap Top 5 / Top 10.",
    hiw3_n: "03",
    hiw3_t: "Start the Tour",
    hiw3_d: "One tap builds the route, then start walking.",
    hiw4_n: "04",
    hiw4_t: "Follow the Route",
    hiw4_d: "Follow the blue line and Bengali voice guide.",
    ...
    biz_sec_sub: "Featured shops and eateries nearby",
    biz_sponsored: "(Sponsored)",
    biz_empty: "Want to feature your business? Contact: +91 62951 11477, +91 99079 62182",
  ...
  bng: {
    ...
    hero_intro_text: "Bardhaman o Katwar sera Durga Puja mondop gulo sobcheye kom somoye ghure dekhun. Amader route planner nijei sobcheye kom durutte route toiri kore, ar Bangla voice guide diye hãtar poth dekhay. Free, login charai.",

    // Section 2: Features
    feat_sec_title: "Shudhu route planner noy",
    feat_sec_sub: "Pujo parikramar sob tool",
    feat1_card_t: "Sera mondop ek tap-e",
    feat1_card_d: "Top 5, Top 10 ba Top 15 — system nijei sera route banay.",
    feat2_card_t: "Somoy onujayi route",
    feat2_card_d: "2 ghonta theke sara din — jotota somoy ache, tototai mondop.",
    feat3_card_t: "Jekono mondop khujun",
    feat3_card_d: "Search kore sorasori Google Maps-e navigate korun.",
    feat4_card_t: "Nijer route banan",
    feat4_card_d: "Map theke pochhonder mondop bachun, system route sajiye debe.",
    feat5_card_t: "Bondhuder sathe share",
    feat5_card_d: "Route baniye link share korun, bondhurao eki route pabe.",
    feat6_card_t: "Bangla-y Voice Guide",
    feat6_card_d: "More more Bangla-y nirdeshona, phone-e takate hobe na.",

    // Section 3: How it works
    hiw_sec_title: "Kivabe byabahar korben?",
    hiw_sec_sub: "Matro 4-ti sohoj dhape shuru",
    hiw1_n: "01",
    hiw1_t: "Location chalu korun",
    hiw1_d: "Browser tomar location shonakhto korbe.",
    hiw2_n: "02",
    hiw2_t: "Shomoy beche nin",
    hiw2_d: "2/4/6 ghonta beche nin, ba Top 5 / Top 10 tap korun.",
    hiw3_n: "03",
    hiw3_t: "Parikrama shuru korun",
    hiw3_d: "Ek tape route toiri hobe, tarpor hãtতে shuru korun.",
    hiw4_n: "04",
    hiw4_t: "Route onushoron korun",
    hiw4_d: "Nil route o Bangla voice guide onushoron korun.",
    ...
    biz_sec_sub: "Kacher dokan o khabarer jayga",
    biz_sponsored: "(Sponsored)",
    biz_empty: "Tomar byabasa ekhane dekhate chan? Jogajog korun: +91 62951 11477, +91 99079 62182",

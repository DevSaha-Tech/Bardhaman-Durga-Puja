...
import { MapPin, MousePointerClick, Navigation, Clock } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          <div className="relative z-10 flex flex-col items-center text-center hover:-translate-y-2 transition-all duration-500 group delay-100">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-xl shadow-amber-900/5 border-4 border-amber-50 mb-8 relative group-hover:border-amber-200 transition-colors">
              ...
              <Clock className="w-10 h-10 text-amber-500 group-hover:scale-110 transition-transform duration-300" />
            </div>
          ...
          <div className="relative z-10 flex flex-col items-center text-center hover:-translate-y-2 transition-all duration-500 group delay-200">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-xl shadow-amber-900/5 border-4 border-amber-50 mb-8 relative group-hover:border-amber-200 transition-colors">
              ...
              <MousePointerClick className="w-10 h-10 text-blue-600 group-hover:scale-110 transition-transform duration-300" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-3">{t('hiw_step3_t_new')}</h3>
            <p className="text-gray-600 text-lg leading-relaxed">{t('hiw_step3_d_new')}</p>
          </div>

          {/* Step 4 */}
          <div className="relative z-10 flex flex-col items-center text-center hover:-translate-y-2 transition-all duration-500 group delay-300">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-xl shadow-amber-900/5 border-4 border-amber-50 mb-8 relative group-hover:border-amber-200 transition-colors">
              <span className="absolute -top-3 -right-3 w-10 h-10 bg-gradient-to-br from-red-700 to-red-900 text-white rounded-full flex items-center justify-center font-bold text-lg border-4 border-[#FAF8F5] shadow-sm font-sans">4</span>
